...
class EducationSerializer(serializers.ModelSerializer):
    ...
    #     start_date = obj.start_date.strftime("%Y")
    #     end_date = obj.end_date.strftime("%Y")
    #     period = int(start_date) - int(end_date)
    #     return f"{start_date} - {end_date} - {period} Yrs"


class ExperienceSerializer(serializers.ModelSerializer):
    # employment_type = EmploymentTypeSerializer() BURDA BUNU AKTIV ELIYENDE KOD ITIR
...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        skills = SkillsSerializer(instance.skills.all(), many=True).data
